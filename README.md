...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:abhyudaypratap/stack-overflow-clone-web.git; cd stack-overflow-clone-web; fab init
...
## How to release Stack Overflow Clone
...
[contributing]: http://github.com/abhyudaypratap/stack-overflow-clone-web/tree/master/CONTRIBUTING.md
