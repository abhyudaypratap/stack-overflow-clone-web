"""Django settings for Stack Overflow Clone project.
...
APPS_DIR = ROOT_DIR.path('stack_overflow_clone')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'stack_overflow_clone.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'stack_overflow_clone.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'stack_overflow_clone.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='Stack Overflow Clone')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='Stack Overflow Clone')
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'stack_overflow_clone.urls'
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='Stack Overflow Clone <support@stack_overflow_clone.com>')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[Stack Overflow Clone] ')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/stack_overflow_clone'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'stack_overflow_clone.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'stack_overflow_clone.base.views.csrf_failure'
...
def get_release():
    import stack_overflow_clone
    release = stack_overflow_clone.__version__
    return release
