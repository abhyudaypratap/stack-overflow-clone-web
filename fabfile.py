...
#  Settings
# ==========================================================================
env.project_name = 'stack_overflow_clone'
...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['dev.stack_overflow_clone.com']
    env.dotenv_path = '/home/ubuntu/dev/stack_overflow_clone/.env'
...
def qa():
    ...
    env.remote = 'origin'
    env.branch = 'qa'
    env.hosts = ['qa.stack_overflow_clone.com']
    env.dotenv_path = '/home/ubuntu/qa/stack_overflow_clone/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.stack_overflow_clone.com']
    env.dotenv_path = '/home/ubuntu/prod/stack_overflow_clone/.env'
    env.config_setter = fab.run
